...
**Long-run packaging:** installable Operator Desk (Mac/Windows) — **`docs/PACKAGING_ROADMAP.md`**. New features should stay package-friendly (snapshot/readers, package-data, dual_system roles; no cloud book sync).
